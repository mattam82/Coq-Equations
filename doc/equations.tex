...
\cite{sozeau.Coq/Equations/ITP10}, this manual provides an
overview of the system by way of introductory examples
(\autoref{cha:gentle-intro}), and a comprehensive documentation of
...
\texttt{opam} installation, simply input the command:
\begin{verbatim}
# opam install coq-equations
\end{verbatim}

The development version which can be installed by hand is available at
\url{http://github.com/mattam82/Coq-Equations}.
