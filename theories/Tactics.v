...
Ltac get_first_elim c k :=
  match c with
  | ?x ?a ?b ?c ?d ?e ?f ?g ?h ?i ?j ?k ?l ?m => k (x a b c d e f g h i j k l)
  | ?x ?a ?b ?c ?d ?e ?f ?g ?h ?i ?j ?k ?l => k (x a b c d e f g h i j k)
  | ?x ?a ?b ?c ?d ?e ?f ?g ?h ?i ?j ?k => k (x a b c d e f g h i j)
  | ?x ?a ?b ?c ?d ?e ?f ?g ?h ?i ?j => k (x a b c d e f g h i)
  | ?x ?a ?b ?c ?d ?e ?f ?g ?h ?i => k (x a b c d e f g h)
  | ?x ?a ?b ?c ?d ?e ?f ?g ?h => k (x a b c d e f g)
  | ?x ?a ?b ?c ?d ?e ?f ?g => k (x a b c d e f)
  | ?x ?a ?b ?c ?d ?e ?f => k (x a b c d e)
  | ?x ?a ?b ?c ?d ?e => k (x a b c d)
  | ?x ?a ?b ?c ?d => k (x a b c)
  | ?x ?a ?b ?c => k (x a b)
  | ?x ?a ?b => k (x a)
  | ?x ?a => k x
