...
Proof.
  depind q; simp scope_le_app. destruct e. simp scope_le_app.
  now rewrite IHq.
Qed.
...
Proof. intros n m Γ; depind Γ. constructor; auto. now constructor 2. Defined.
...
Proof with autorewrite with lift_var_by map_var scope_le_app in *; auto.
  ...
  - generalize dependent p. generalize dependent t. depind q; intros...
    simpl in e. revert e. simplify ?. intros...
    rewrite IHp...
    specialize (IHp _ q).
...
Proof with autorewrite with lookup scope_le_app env_app lift_var_by lift_type_by; auto.
  intros n Γ m Δ; induction Δ; intros x; simpl... destruct e...
  rewrite IHΔ... 
Qed.
...
Proof. depind Γ. depelim e. constructor. constructor; auto using sa_refl. Qed.
...
Proof.
  ...
  try constructor; auto. destruct e. constructor.
Qed.
...
Proof.
  ...
  depelim x; try depelim e; simpl in *;
