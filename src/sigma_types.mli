...
val mkSig :
  Evd.evar_map ref -> Names.Name.t Constr.binder_annot * types * constr -> constr
val constrs_of_coq_sigma : 
  Environ.env ->
  Evd.evar_map ref ->
  constr ->
  constr -> (Names.Name.t Constr.binder_annot * constr * constr * constr) list
...
val curry : Evd.evar_map -> Names.Name.t Constr.binder_annot -> constr ->
            rel_context * constr
