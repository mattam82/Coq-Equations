...
- [Intro](equations_intro.html): introduction to Equations, demonstrating
  its features
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/doc/equations_intro.v),
  [JSCoq](../assets/jsexamples/equations_intro.html)).

- [Basics](examples/Examples.Basics.html): Basic examples of Equations usage
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/Basics.v)).
...
- [Vectors](examples/Examples.working_with_vectors.html): an example use to program 
  ...
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/working_with_vectors.v)).
...
- [Polynomials](examples/Examples.polynomials.html): a reflexive tactic for
  ...
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/polynomials.v)).

- [HoTT_light](examples/Examples.HoTT_light.html): basics of the HoTT library
  implemented using a logic in `Type`
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/HoTT_light.v)).
...
- [MoreDep](examples/Examples.MoreDep.html): part of chapter 8 of Adam
  ...
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/MoreDep.v)).
...
- [Definitional interpreter](examples/Examples.definterp.html): definitional interpreter
  ...
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/definterp.v)).
...
- [POPLMark 1a](examples/Examples.POPLMark1a.html): a solution to
  ...
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/POPLMark1a.v)).
...
- [Views](examples/Examples.views.html): using dependent pattern-matching with
  ...
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/views.v)).
...
- [STLC](examples/Examples.STLC.html): strong normalization of simply-typed
  ...
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/STLC.v)).
...
- [String Matching](examples/Examples.string_matching.html): beginning of example
  ...
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/string_matching.v)).

- [Rose Trees](examples/Examples.RoseTree.html): nested well-founded recursion
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/RoseTree.v)).

- [Nested mutual recursion](examples/Examples.nested_mut_rec.html): structural mutual and nested recursion
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/nested_mut_rec.v)).
...
- [Accumulators](examples/Examples.accumulator.html): defining and proving
  ...
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/accumulator.v)).
...
- [Mutual well-founded recursion](examples/Examples.mutualwfrec.html):
  ...
  dependent pattern-matching
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/mutualwfrec.v)).
...
- [General recursion](examples/Examples.general_recursion.html): working with
  ...
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/general_recursion.v)).
...
- [Higher-order recursion](examples/Examples.ho_finite_branching.html):
  ...
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/ho_finite_branching.v)).
...
- [Bove Capretta](examples/Examples.bove_capretta.html): using the
  ...
  ([source](https://raw.githubusercontent.com/mattam82/Coq-Equations/refs/heads/main/examples/bove_capretta.v)).
